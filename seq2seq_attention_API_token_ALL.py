...
class seq2seq_Attention_token_all():
    ...
    def __init__(self):
        ...
        self.path_to_file = file_path + '/QA_all_token.txt'
...
#                         validation_split=0.2)
    ...
    def createAttentionInference(self, model, attention_mode=False):
        ...
        model.load_weights(file_path + "/P4.h5", by_name = True)
...
test = seq2seq_Attention_token_all()
##model = test.train()
model = test.create_model()
encoder_Inference, decoder_Inference = test.createAttentionInference(model)
##
print(test.translate("新貴通會員卡更改寄送地址，請致電客服中心(02)8982-0000轉接專人辦理。", encoder_Inference, decoder_Inference, True))
#
